...
public class DataTree {
    ...
    public void createNode(final String path, byte[] data, List<ACL> acl, long ephemeralOwner, int parentCVersion, long zxid, long time, Stat outputStat) throws NoNodeException, NodeExistsException {
        ...
        synchronized (parent) {
            ...
            addEphemeralNode(path, ephemeralOwner);
    ...
    private void addEphemeralNode(String path, long ephemeralOwner) {
        ...
        try {
            ...
            switch (header.getType()) {
                ...
                case OpCode.multi:
                    ...
                    processMultiTxn(header, multiTxn, rc);
                    break;
            }
    ...
    private void processMultiTxn(TxnHeader header, MultiTxn multiTxn, ProcessTxnResult rc) throws KeeperException, IOException {
